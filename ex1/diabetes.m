...
[Ysim, Ylatent] = simlssvm({Xtrain,Ytrain,type,gam,[],'lin_kernel', 'preprocess'}, {alpha,b}, Xtest);
...
[Ysim, Ylatent] = simlssvm({Xtrain,Ytrain,type,gam,sig2,'RBF_kernel', 'preprocess'}, {alpha,b}, Xtest);
